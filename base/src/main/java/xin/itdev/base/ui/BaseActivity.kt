...
import xin.itdev.base.utils.ActivityUtil
import xin.itdev.base.utils.StatusBarUtil
import xin.itdev.base.widget.LoadingView
...
open class BaseActivity  : AppCompatActivity() {
    ...
    open fun initTop() {
        StatusBarUtil.setColorForSwipeBack(this, ContextCompat.getColor(this, R.color.colorWhite), 0)
        val status = StatusBarUtil.StatusBarLightMode(this)
        if (status == 0) {
